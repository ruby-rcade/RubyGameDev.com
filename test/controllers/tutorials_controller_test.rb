...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { body_html: @tutorial.body_html, body_markdown: @tutorial.body_markdown, draft: @tutorial.draft, published_on: @tutorial.published_on, title: @tutorial.title, url: @tutorial.url, user_id: @tutorial.user_id }
    end
  ...
  test "should update tutorial" do
    patch :update, id: @tutorial, tutorial: { body_html: @tutorial.body_html, body_markdown: @tutorial.body_markdown, draft: @tutorial.draft, published_on: @tutorial.published_on, title: @tutorial.title, url: @tutorial.url, user_id: @tutorial.user_id }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
